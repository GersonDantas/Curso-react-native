...
import ListaScroll from './componentes/listaFlex';
...
export default function Routes() {
  return (
    <Drawer.Navigator initialRouteName='Flex'>
      <Drawer.Screen name='Flex' component={Flex} title={{ title: 'flex box' }}/>
      <Drawer.Screen name='ListaScroll' title={{ title: 'scroll (flex box)' }}>
        {
